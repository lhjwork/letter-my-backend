...
#### 1. 자동저장
- **3초 지연**: 사용자가 타이핑을 멈춘 후 3초 뒤 자동저장
- **디바운싱**: 연속된 입력에 대해 효율적인 저장
...
#### 4. 오프라인 지원
- **로컬 백업**: 네트워크 오류 시 로컬스토리지에 백업
- **자동 복원**: 페이지 새로고침 시 백업 데이터 복원
